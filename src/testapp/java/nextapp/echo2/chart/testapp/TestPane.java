...
public class TestPane extends ContentPane {
    ...
    private ActionListener commandActionListener = new ActionListener() {
        ...
        public void actionPerformed(ActionEvent e) {
            try {
                ...
                activeButton = button;
                String screenClassName = "nextapp.echo2.chart.testapp.testscreen." + e.getActionCommand();
    ...
    public TestPane() {
        ...
        Label titleLabel = new Label("NextApp Echo2 ChartDisplay Test Application");
